...
<div class="row hidden" id="dvRow1">
...
<div class="modal-dialog modal-lg" role="document">
  <div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">
						<i class="fa fa-table" aria-hidden="true"></i> TICKET TOTALES
					</h3>
				</div>
				<div class="box-body">
					<div class="row">
...
<!--         <h4 class="modal-title">TICKET TOTALES</h4> -->
<!--       </div> -->
...
<!-- 	        	<div class="box-body"> -->
<!-- 					<label id="lblMessage" class="label label-info"></label> -->
<!-- 					<div id="tbcontainerticket" class="table-responsive"> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!--         	</div> -->
<!--         </div> -->
...
// 	$('#btnConsultar').button('loaging');
	...
	function listSLA_EspecialistasPrioridad(pPrioridad){
		...
		$(document).ready(function() {
			...
			$.post(src, {strOperation : 'listSLA_EspecialistasPrioridad', strFechaInicio : pstrInicio, strFechaFin : pstrFin, iPrioridad : pPrioridad, strProyecto : pstrProyecto},
					function(pdata) {
				 ...
				 var obj = JSON.parse(pdata);
				  ...
				  var columnsReport = [];
					  for(i = 0 ; i < obj.reporte.length ; i++ )
					  	{
						var arr = [];
						arr.push(obj.reporte[i].ownerId);
						arr.push(obj.reporte[i].owner);
						arr.push(obj.reporte[i].total);
						arr.push(obj.reporte[i].prom);
					...
					setDataPriority(dataReporte,columnsReport,pPrioridad)
