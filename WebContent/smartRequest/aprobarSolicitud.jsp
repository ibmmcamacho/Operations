...
<h1>
	SMART REQUEST<small> Aprobar Solicitudes</small>
</h1>
<ol class="breadcrumb">
	<li><a href="#"><i class="fa fa-windows"></i> SMART REQUEST</a></li>
	<li class="active"> Aprobar Solicitudes</li>
</ol>
	...
	<div class="col-lg-12 connectedSortable">
		<div class="box box-primary" style="max-width:95%;margin-left:auto;margin-right:auto;">
			<div class="box-header with-border">
				<h3 class="box-title"> <i class="fa fa-table" aria-hidden="true"></i> Solicitudes</h3>
			</div>
			<div class="box-body">
		    <label >Estado: </label>
	         <select class="form-control select2"  id="" style="max-width:30%;">
...
$(document).ready(function() {
	...
	$("#btnVer1").click(function(){
		javascript:recargarDiv('wcontentRight','<%=request.getContextPath()%>/smartRequest/solicitudPendienteRevisor.jsp');
	});
	
	$("#btnVer2").click(function(){
		javascript:recargarDiv('wcontentRight','<%=request.getContextPath()%>/smartRequest/solicitudPendienteAprobador.jsp');
	});
	
	$("#btnVer3").click(function(){
		javascript:recargarDiv('wcontentRight','<%=request.getContextPath()%>/smartRequest/solicitudPendienteVisador.jsp');
	});
	...
	function listReportConsumoDisco() {
					  ...
					  var columnsReport = [];
							...
							arr2.push("F000002");
							arr2.push("30-05-2018");
							arr2.push("Alta");
							arr2.push("Usuario Temporal");
							arr2.push("Anthony Canales");
							arr2.push("PENDIENTE APROBADOR");
							arr2.push("<div class=\"text-center\"><button id=\"btnVer2\"  title=\"Ver solicitud\" type=\"button\" class=\"btn bg-primary\"\"> "+
									"<i class=\"fa fa-eye fa-pull-center\"></i></button><div>");
							dataReporte.push(arr2);
