...
<div class="row container-fluid" id="divFormulario" style='display:block;'>
		...
		<div class="panel panel-primary" style="max-width:90%;margin-left:auto;margin-right:auto;">
		  ...
		  <div class="col-md-6"><i class="fa fa-check fa-2x" style="color:#51acc7"></i>01-06-2018  18:00:00 </div>		  
		  </div>
		  <br>
		  <div class="row">
		...
		<!-- correcto -->
		<div class="trans text-center" style='display:none;'> 
		    <button id="btnRegistrar" name="singlebutton" class="btn btn-success btn-lg " disabled><i class="fa fa-save" > Guardar</i></button> 
		    <button id="btnLimpiar" name="singlebutton" class="btn btn-primary btn-lg" disabled><i class="fa fa-eraser"> Limpiar</i></button>
		    <button id="btnCancelar" name="singlebutton" class="btn btn-danger btn-lg" disabled><i class="fa fa-times"> Cancelar</i></button>  
		</div>
